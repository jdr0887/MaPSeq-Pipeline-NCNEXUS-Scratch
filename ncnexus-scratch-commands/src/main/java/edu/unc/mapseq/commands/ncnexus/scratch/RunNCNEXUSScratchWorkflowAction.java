package edu.unc.mapseq.commands.ncnexus.scratch;
...
@Command(scope = "ncnexus-scratch", name = "run-workflow", description = "Run NCNEXUS Scratch Workflow")
public class RunNCNEXUSScratchWorkflowAction extends AbstractAction {
    ...
    public RunNCNEXUSScratchWorkflowAction() {
        super();
    }
    ...
    public Object doExecute() {
        ...
        try {
            ...
            Destination destination = session.createQueue("queue/ncnexus.scratch");
