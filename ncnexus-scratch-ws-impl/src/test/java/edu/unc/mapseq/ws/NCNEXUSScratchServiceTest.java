...
import edu.unc.mapseq.ws.ncnexus.scratch.NCNEXUSScratchService;
import edu.unc.mapseq.ws.ncnexus.scratch.QualityControlInfo;

public class NCNEXUSScratchServiceTest {

    @Test
    public void testCoverageResults() {
        QualityControlInfo ret = new QualityControlInfo();
        try {
            InputStream is = NCNEXUSScratchServiceTest.class.getResourceAsStream("coverage.out");
    ...
    public void testLookupQuantificationResults() {
        QName serviceQName = new QName("http://scratch.ncnexus.ws.mapseq.unc.edu", "NCNEXUSScratchService");
        QName portQName = new QName("http://scratch.ncnexus.ws.mapseq.unc.edu", "NCNEXUSScratchPort");
        Service service = Service.create(serviceQName);
        String host = "152.19.198.146";
        service.addPort(portQName, SOAPBinding.SOAP11HTTP_MTOM_BINDING,
                String.format("http://%s:%d/cxf/NCNEXUSScratchService", host, 8181));
        NCNEXUSScratchService webService = service.getPort(NCNEXUSScratchService.class);
