...
public class NCNEXUSScratchMessageListener extends AbstractMessageListener {

    private final Logger logger = LoggerFactory.getLogger(NCNEXUSScratchMessageListener.class);

    public NCNEXUSScratchMessageListener() {
        super();
    }
