...
public class MessageTest {
    ...
    public void testQueue() {
        ...
        try {
            ...
            producer.send(session.createTextMessage(String.format(format, 67401, "jdr-ncnexus-scratch",
    ...
    public void testEntireFlowcellBySample() throws IOException {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                producer.send(session.createTextMessage(String.format(format, line.trim(),
                        "jdr-test-ncnexus-scratch", DateFormatUtils.ISO_TIME_NO_T_FORMAT.format(new Date()))));
                try {
                    Thread.sleep(1000);
